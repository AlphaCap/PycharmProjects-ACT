...
try:
    ...
    st.error("Could not import PolygonClient. Make sure utils/polygon_api.py is available.")
...
st.markdown("This system will utilize 1-minute bar data from Polygon.io to generate trading signals.")
