...
class SectorParameterManager:
    ...
    def _save_to_history(self, sector: str, old_params: Dict, new_params: Dict, 
    ...
    def update_sector_parameters(self, sector: str, new_parameters: Dict, 
        ...
        self.sector_parameters[sector]['optimization_source'] = f"{self.sector_etfs.get(sector, 'Unknown')} ETF"
    ...
    def reset_sector_parameters(self, sector: str):
        ...
        if sector in self.sector_parameters:
            ...
            self._save_parameters()
            self._save_to_history(sector, old_params, {}, {'action': 'reset_to_default'})
            print(f"✅ Reset {sector} to default parameters")
        else:
            print(f"ℹ️  {sector} was already using default parameters")
...
if __name__ == "__main__":
    ...
    manager.update_sector_parameters('Technology', tech_optimized_params, 
